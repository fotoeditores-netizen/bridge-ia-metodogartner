...
const ACRONYM = [
  ...
  { letter: "T", word: "Traducir necesidades en soluciones", description: "Transforma entornos productivos apoyado en nuevas tecnologías.", color: "text-amber-400", bg: "bg-amber-500/15 border-amber-500/30" },
