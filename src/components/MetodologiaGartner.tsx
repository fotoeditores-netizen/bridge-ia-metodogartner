...
const ACRONYM = [
  { letter: "G", word: "Generar", description: "Genera conciencia y alineación organizacional en torno al potencial transformador de la IA.", color: "text-emerald-400", bg: "bg-emerald-500/15 border-emerald-500/30" },
  { letter: "A", word: "Alinear", description: "Alinea el liderazgo con una visión estratégica clara y objetivos de IA medibles.", color: "text-blue-400", bg: "bg-blue-500/15 border-blue-500/30" },
  { letter: "R", word: "Reconocer", description: "Reconoce los perfiles individuales y colectivos para diseñar rutas de adopción personalizadas.", color: "text-violet-400", bg: "bg-violet-500/15 border-violet-500/30" },
  { letter: "T", word: "Teorizar", description: "Teoriza y establece los fundamentos conceptuales que permiten tomar decisiones informadas.", color: "text-amber-400", bg: "bg-amber-500/15 border-amber-500/30" },
  { letter: "N", word: "Navegar", description: "Navega los talleres sectoriales aplicando IA en el contexto real de tu industria.", color: "text-orange-400", bg: "bg-orange-500/15 border-orange-500/30" },
